...
with bz2.BZ2File('meta-20201109.txt.bz2', 'r') as json_file, open('dedde.json', 'a') as outfile1:
	for line in json_file:
		...
		if decoded["dst_addr"] == "8.8.4.4" and decoded["is_oneoff"] == False  and decoded["start_time"] < 1609020000 and decoded["type"]["name"]=="dns":
