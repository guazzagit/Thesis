...
df1=pd.read_csv(Input_Base,parse_dates=['timestamp'],dtype={'prb_id': str,'resultset.result.rt': str})
df= pd.read_csv(Input_twoYears,parse_dates=['timestamp'],dtype={'prb_id': str,'resultset.result.rt': str})
