...
df1=pd.read_csv(Input_Base,parse_dates=['timestamp'],dtype={'prb_id': int,'resultset.result.rt': int})
df= pd.read_csv(Input_twoYears,parse_dates=['timestamp'],dtype={'prb_id': int,'resultset.result.rt': int})
