...
data = []
with open('C:/Users/guazz//Documents/GitHub/Thesis/python file/23324638_ping_2020_format_dataCambiata.json','r') as f:
    for line in f:
...
#print (rs)
print("creo csv")
data.to_csv(r'C:/Users/guazz//Documents/GitHub/Thesis/python file/23324638_ping_2020_format_dataCambiata.csv')
print("fatto csv")
