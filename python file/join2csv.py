...
df1 = pd.read_csv('12001626_quad1_2019_formattato_dataCambiata_NOERROR_abuf.csv')
df2 = pd.read_csv('12001626_quad1_2020_formattato_dataCambiata_NOERROR_abuf.csv',dtype={'mver': str})
