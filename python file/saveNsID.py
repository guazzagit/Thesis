...
def do_name(buf, offset):
	...
	while True:
		...
		if llen <= 63:
			...
			if name == '' or label !='':
				#print(label)
				#print(name + label.decode("utf-8")  + '.')
				
				name= name + label.decode("utf-8")  + '.'
